Knowledge graphs have become a central representation for structured knowledge extracted
from text. Early work on ontology learning~\cite{buitelaar2005ontologylearning} established
methods for inducing concept hierarchies and relations from corpora using linguistic
patterns and statistical co-occurrence. \citet{hogan2021kgsurvey} provide a comprehensive
...
mode of evaluation and \emph{task-based} evaluation --- assessing a KG by its utility on
...
in response to the downstream task. Rather than learning better \emph{from} a fixed
