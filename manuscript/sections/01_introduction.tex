...
Existing KG 
construction tools --- from manual ontology engineering to LLM-driven
...
no existing work closes the loop at construction time: no lightweight,
...
advance, we propose a closed-loop system in which: (i)~an Ontology Agent
proposes candidate ontology configurations; (ii)~a KG Builder Agent constructs
...
performance converges. Figure~\ref{fig:architecture}
